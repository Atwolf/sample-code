...
class ADKAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            sub_agents: Optional selectable AG-UI ADKAgent registry consumed by
                add_adk_fastapi_endpoint when endpoint-level sub_agents are not
                provided.
            select_agent_from_state: Optional request-scoped selector consumed by
                add_adk_fastapi_endpoint when endpoint-level selector is not
                provided.
        ...
        self._select_agent_from_state = select_agent_from_state
